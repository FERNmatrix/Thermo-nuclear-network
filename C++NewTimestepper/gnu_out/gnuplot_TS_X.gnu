...
plot file1 using 2:10 with lines ls 2 title "4He"
replot file1 using 2:11 with lines ls 3 title "12C"
replot file1 using 2:12 with lines ls 1 title "16O"
replot file1 using 2:13 with lines ls 4 title "20Ne"
