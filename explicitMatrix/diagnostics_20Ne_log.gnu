...
plot file1 using (log10($6)):(log10($7)) with lines ls 1 lw 1.0 dashtype 1 title "Asy-Y0[20Ne]"
replot file1 using (log10($6)):(1.05*log10($8)) with lines ls 2 lw 1.0 dashtype 1 title "1.05*Asy-Y[20Ne]"

file2 = "gdb-C++_PE_20Ne.out"

replot file2 using (log10($6)):(log10($7)) with lines  ls 1 lw 1.0 dashtype 2 title "PE-Y0[20Ne]"
replot file2 using (log10($6)):(1.05*log10($8)) with lines  ls 2 lw 1.0 dashtype 2 title "1.05*PE-Y[20Ne]"
