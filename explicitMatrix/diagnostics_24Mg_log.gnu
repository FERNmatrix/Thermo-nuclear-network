...
plot file1 using (log10($6)):(log10($7)) with lines ls 1 lw 1.0 dashtype 1 title "Asy-Y0[24Mg]"
replot file1 using (log10($6)):(1.05*log10($8)) with lines ls 2 lw 1.0 dashtype 1 title "1.05*Asy-Y[24Mg]"

file2 = "gdb-C++_PE_24Mg.out"

replot file2 using (log10($6)):(log10($7)) with lines  ls 1 lw 1.0 dashtype 2 title "PE-Y0[24Mg]"
replot file2 using (log10($6)):(1.05*log10($8)) with lines  ls 2 lw 1.0 dashtype 2 title "1.05*PE-Y[24Mg]"
