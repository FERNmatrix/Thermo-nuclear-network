...
plot file1 using (log10($6)):(log10($7)) with lines ls 1 lw 1.0 dashtype 1 title "Asy-Y0[28Si]"
replot file1 using (log10($6)):(1.02*log10($8)) with lines ls 2 lw 1.0 dashtype 1 title "1.02*Asy-Y[28Si]"

file2 = "gdb-C++_PE_28Si.out"

replot file2 using (log10($6)):(log10($7)) with lines  ls 1 lw 1.0 dashtype 2 title "PE-Y0[28Si]"
replot file2 using (log10($6)):(1.02*log10($8)) with lines  ls 2 lw 1.0 dashtype 2 title "1.02*PE-Y[28Si]"
