...
plot file1 using 4:7 with lines ls 2 lw 1.0 dashtype 1 title "Asy-Y[32S]"
replot file1 using 4:6 with lines ls 2 lw 1.0 dashtype 2 title "Asy-Y0[32S]"

file2 = "temp_asyPE_plot.out"

replot file2 using 4:7 with lines  ls 3 lw 1.0 dashtype 1 title "PE-Y[32S]"
replot file2 using 4:6 with lines  ls 3 lw 1.0 dashtype 2 title "PE-Y0[32S]"
