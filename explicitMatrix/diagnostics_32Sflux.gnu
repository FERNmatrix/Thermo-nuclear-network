...
#plot file1 using 4:8 with lines ls 2 lw 1.5 dashtype 1 title "c++ Asy F+[32S]"
#replot file1 using 4:9 with lines ls 2 lw 1.5 dashtype 1 title "c++ Asy F-[32S]"
...
replot file2 using 4:8 with lines  ls 3 lw 1.5 dashtype 2 title "c++ PE F+[32S]"
replot file2 using 4:9 with lines  ls 11 lw 1.5 dashtype 2 title "c++ PE F-[32S]"
...
#replot file4 using 3:(log10(abs($9))) with lines ls 10 lw 1.5 dashtype 1 title "java asy |dF[32S]|"
...
replot file3 using 3:(log10(abs($9))) with lines ls 10 lw 1.5 dashtype 1 title "java PE |dF[32S]|"
