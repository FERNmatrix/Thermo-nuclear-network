...
plot file1 using (log10($6)):(log10($7)) with lines ls 1 lw 1.0 dashtype 1 title "Asy-Y0[4He]"
replot file1 using (log10($6)):(1.005*log10($8)) with lines ls 2 lw 1.0 dashtype 1 title "1.005*Asy-Y[4He]"

file2 = "gdb-C++_PE_4He.out"

replot file2 using (log10($6)):(log10($7)) with lines  ls 1 lw 1.0 dashtype 2 title "PE-Y0[4He]"
replot file2 using (log10($6)):(1.005*log10($8)) with lines  ls 2 lw 1.0 dashtype 2 title "1.005*PE-Y[4He]"
