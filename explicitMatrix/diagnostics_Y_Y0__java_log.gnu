...
replot file1 using (log10($3)):(log10($6)) with lines ls 7 lw 1.5  dashtype 2 title "java Y0[6]"
...
set out "diagnostics_Y_Y0__java_log.eps"    # Output file
set terminal postscript eps size width, height enhanced color solid lw 2 "Arial" 24
replot               # Plot to postscript file

# Plot to PNG file

#set out "diagnostics_Y_Y0_java_log.png"
