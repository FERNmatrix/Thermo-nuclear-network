...
plot file1 using (log10($3)):(log10($10-$13)) with lines ls 4 lw 1.5  dashtype 1 title "java F+(0)-F-(0)"
replot file1 using (log10($3)):(log10($11-$14))  with lines ls 5 lw 1.5 dashtype 1 title "java F+(5)-F-(5)"
replot file1 using (log10($3)):(log10($12-$15)) with lines ls 2 lw 1.5 dashtype 1 title "java F+(6)-F-(6)"
...
replot file2 using (log10($3)):(log10($10-$13)) with lines ls 4 lw 1.5  dashtype 2 title "C++ F+(0)-F-(0)"
replot file2 using (log10($3)):(log10($11-$14))  with lines ls 5 lw 1.5 dashtype 2 title "C++ F+(5)-F-(5)"
replot file2 using (log10($3)):(log10($12-$15)) with lines ls 2 lw 1.5 dashtype 2 title "C++ F+(6)-F-(6)"
