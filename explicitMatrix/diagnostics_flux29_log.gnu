...
plot file1 using (log10($2)):(log10($6)) with lines ls 1 lw 1.0 dashtype 1 title "asy-flux-29"
replot file1 using (log10($2)):(log10($7)) with lines ls 2 lw 1.0 dashtype 1 title "asy-kfac-29"
replot file1 using (log10($2)):(log10($8)) with lines ls 14 lw 1.0  dashtype 1 title "asy-Y[6]-29"
#replot file1 using (log10($2)):(log10($9)) with lines ls 10 lw 1.0  dashtype 1 title "asy-Y0[6]-29"
...
file2 = "gdb-C++_PE_29.out"

replot file2 using (log10($2)):(log10($6)) with lines  ls 1 lw 1.0 dashtype 2 title "PE-flux-29"
replot file2 using (log10($2)):(log10($7)) with lines  ls 2 lw 1.0 dashtype 2 title "PE-kfac-29"
replot file2 using (log10($2)):(log10($8)) with lines  ls 14 lw 1.0  dashtype 2 title "PE-Y[6]-29"
#replot file2 using (log10($2)):(log10($9)) with lines  ls 10 lw 1.0  dashtype 2 title "PE-Y0[6]-29"
