...
#---------------------PLOT DT vs T -------------------------#
plot file1 using 1:2 with lines ls 1 title "Benchmark dt"
replot file2 using 1:2 with lines ls 2 title "dt"
#-----------------------------------------------------------#
...
plot file4 using 1:8 with lines ls 1 title "4He"
replot file5 using 1:8 with lines ls 2 title "TS-HE"

replot file4 using 1:9 with lines ls 3 title "12C"
replot file5 using 1:9 with lines ls 4 title "TS-C"

replot file4 using 1:10 with lines ls 5 title "16O"
replot file5 using 1:10 with lines ls 6 title "TS-O"

replot file4 using 1:11 with lines ls 7 title "20Ne"
replot file5 using 1:11 with lines ls 8 title "TS-Ne"

replot file4 using 1:12 with lines ls 9 title "24Mg"
replot file5 using 1:12 with lines ls 10 title "TS-Mg"

replot file4 using 1:13 with lines ls 11 title "28Si"
replot file5 using 1:13 with lines ls 12 title "TS-Si"

replot file4 using 1:14 with lines ls 13 title "32S"
replot file5 using 1:14 with lines ls 14 title "TS-S"

replot file4 using 1:15 with lines ls 15 title "36Ar"
replot file5 using 1:15 with lines ls 16 title "TS-Ar"

replot file4 using 1:16 with lines ls 17 title "40Ca"
replot file5 using 1:16 with lines ls 18 title "TS-40"

replot file4 using 1:17 with lines ls 19 title "44Ti"
replot file5 using 1:17 with lines ls 20 title "TS-Ti"

replot file4 using 1:18 with lines ls 5 title "48Cr"
replot file5 using 1:28 with lines ls 6 title "TS-Cr"

replot file4 using 1:19 with lines ls 7 title "52Fe"
replot file5 using 1:19 with lines ls 8 title "TS-Fe"

replot file4 using 1:20 with lines ls 9 title "56Ni"
replot file5 using 1:20 with lines ls 10 title "TS-Ni"

replot file4 using 1:21 with lines ls 11 title "60Zn"
replot file5 using 1:21 with lines ls 12 title "TS-Zn"

replot file4 using 1:22 with lines ls 13 title "64Ge"
replot file5 using 1:22 with lines ls 14 title "TS-Ge"

replot file4 using 1:23 with lines ls 15 title "68Se"
replot file5 using 1:23 with lines ls 16 title "TS-Se"
