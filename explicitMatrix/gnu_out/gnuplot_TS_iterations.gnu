...
set ylabel 'Iterations' textcolor rgb tic_color #font "Arial,32"
...
ds="C++ Asy T9=5 rho=1e8 (no pf; new dt)"
ds = ds.": Iterations"
...
plot file1 using 2:7 with lines ls 2 title "Frac Asy"
