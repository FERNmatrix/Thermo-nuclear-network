...
plot file1 using 1:2 with lines ls 1 title "dt"
replot file1 using 1:9 with lines ls 2 title "dF(4He)"
replot file1 using 1:10 with lines ls 3 title "dF(12C)"
replot file1 using 1:11 with lines ls 4 title "dF(16O)"
