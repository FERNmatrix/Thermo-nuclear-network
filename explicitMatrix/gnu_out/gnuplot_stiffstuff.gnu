...
plot file1 using 1:2 with lines ls 1 title "log dt"
replot file1 using 1:5 with lines ls 4 title "log 2/Rmax"
replot file1 using 1:($7+0.301) with lines ls 2 title "log 2*dt_FE"
