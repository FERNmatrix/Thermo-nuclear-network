...
plot file1 using (log10($3)):(log10($7)) with lines ls 1 lw 1.0 dashtype 1 title "java Y[0]"
replot file1 using (log10($3)):(log10($8)) with lines ls 2 lw 1.0 dashtype 1 title "java Y[5]"
replot file1 using (log10($3)):(log10($9)) with lines ls 3 lw 1.0  dashtype 1 title "java Y[6]"
#replot file1 using (log10($3)):(log10($10)) with lines ls 4 lw 1.5  dashtype 1 title "Fplus[0]"
...
replot file2 using (log10($3)):(log10($7)) with lines  ls 1 lw 1.0 dashtype 2 title "c++ Y[0]"
replot file2 using (log10($3)):(log10($8)) with lines  ls 2 lw 1.0 dashtype 2 title "c++ Y[5]"
replot file2 using (log10($3)):(log10($9)) with lines  ls 3 lw 1.0  dashtype 2 title "c++ Y[6]"
