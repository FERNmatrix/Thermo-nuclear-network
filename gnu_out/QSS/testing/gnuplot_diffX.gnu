...
set ylabel 'Log diffX (s)' textcolor rgb tic_color font "Arial,32"
...
plot file1 using 1:8 with lines ls 1 title "diffX"
replot file1 using 1:2 with lines ls 2 title "dt"
...
set ylabel 'Log diffX (s)' textcolor rgb tic_color font "Arial,28"

# Plot to postscript file

set out "gnuplot_diffX.eps"    # Output file
set terminal postscript eps size width, height enhanced color solid lw 2 "Arial" 24
replot               # Plot to postscript file

# Plot to PNG file

set out "gnuplot_diffX.png"
