...
// ---------------------------------------------------------------------------
//  Class RateGraphicsPad create a graphics canvas for the frame on which
...
class RateGraphicsPad extends Canvas {
	...
	*/
    ...
    {  // initializer
		...
		col[45] = new Color(204,51,102);
        col[46] = new Color(204,153,102);
        col[47] = new Color(204,204,102);
        col[48] = new Color(255,153,102);
        col[49] = new Color(204,51,153);
        col[50] = new Color(204,153,153);
        col[51] = new Color(255,51,153);
        col[52] = new Color(255,153,153);
        col[53] = new Color(255,204,153);
        col[54] = new Color(204,51,204);
		col[55] = new Color(51,153,51);
        col[56] = new Color(0,51,102);
        col[57] = new Color(0,153,153);
        col[58] = new Color(0,51,153);
        col[59] = new Color(51,153,153);
    ...
    int x2=StochasticElements.widthRatePlot;    // x lower right
    int y2=StochasticElements.heightRatePlot;   // y lower right
	...
	*/
    ...
    int imax=151;           // Max number of separate curves
    ...
    // Set the colors for the lines and symbols for the curves (imax entries)
  ...
  // each of the curves in the plot legend
    ...
    String xtitle="x-axis";                                   // String for x-axis label
    String ytitle="y-axis";                  // String for y-axis label
